...
# URL = f"https://223.196.186.236/api/v1/visualization/widgets/92323865210"
URL = f"https://223.196.186.236/api/v1/query/visualization/92323865254"
# URL = f"https://223.196.186.236/api/v1/query/objects/severity
...
try:
    ...
    # Save to file
    with open("widget_details.json", "w") as f:
